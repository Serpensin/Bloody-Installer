...
dbd = ("C:\Program Files (x86)\Steam\steamapps\common\Dead by Daylight")
...
def pak():
    if os.path.exists(dbd):
        shutil.copy2('BG\pakchunk1-WindowsNoEditor.pak', os.path.join(dbd, "DeadByDaylight\Content\Paks"))
    else:
